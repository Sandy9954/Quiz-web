...
function ProtectedRoute({ children }) {
    ...
    return ( <
        ...
        div className = "menu" > {
            ...
            div className = "body" >
            <
            div className = "header flex justify-between" > {!collapsed && ( <
            ...
            h1 className = "text-2xl text-white" > QUIZUp < /h1> <
            div >
            <
            div className = "flex gap-1 items-center" >
            <
            h1 className = "text-md text-white" > { user && user.name } < /h1> <
            /div> <
            span > Role: { user && user.isAdmin ? "Admin" : "User" } < /span> <
            /div> <
            /div> <
