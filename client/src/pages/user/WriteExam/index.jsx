...
function WriteExam() {
  ...
  const [progressData, setProgressData] = useState({ attempted: 0, unanswered: 0 });
  ...
  const getExamData = async () => {
    try {
      ...
      if (response.success) {
        ...
        calculateProgress(response.data.questions);
        setProgressData({ attempted: 0, unanswered: 0 });
      } else {
  ...
  const calculateProgress = (questionsData) => {
    ...
    examData && (
      <div className="mt-2">
        ...
        <div className="progress-tracking">
          <p>
            Attempted: {progressData.attempted} | Unanswered:{" "}
            {progressData.unanswered}
          </p>
        </div>
      </div> 
    )
